      ...
      <div class="hero-bg-games">
        <div class="hero-body">
          <div class="container">
            ...
            <h2 class="subtitle">
              <span class="has-text-grey-dark is-size-6 has-background-primary">Have a game in mind?</span>
            </h2>
          </div>
        </div>
      </div>
        ...
        <div class="columns is-mobile is-multiline">
            ...
            <div class="field is-grouped">
              ...
              <div class="control is-hidden-desktop">
                <a
                  ...
                  v-bind:class="{ 'is-outlined': hideFilters }"
                >
              ...
              <div class="field has-addons">
                <div class="control">
                  <a
                    ...
                    v-bind:class="{ 'is-outlined': detailedView }"
                    @click="toggleView"
                  >
                    <span class="icon is-small">
                      <i class="fas fa-th"></i>
                ...
                <div class="control">
                  <a
                    class="button is-medium is-primary"
                    v-bind:class="{ 'is-outlined': simpleView }"
                    @click="toggleView"
                  >
                    <span class="icon is-small">
          ...
          <div class="column is-3-desktop" v-bind:class="{ 'is-hidden-touch': hideFilters }">
            <aside class="menu box">
              <p class="menu-label">Minimum Average Score</p>
              <input
                id="sliderWithValue"
                class="slider has-output is-fullwidth is-primary"
                min="0"
                max="100"
                step="1"
                type="range"
              ...
              <p class="menu-label">Platforms</p>
              <multiselect
              ...
              ></multiselect>
              <p class="menu-label">Publisher</p>
              <multiselect
                    ...
                    <figure class="card image item-shadow imageFade">
                      <a :href="'games/' + game.id">
                        <div class="text-container">
                          <img
                            v-lazy="$store.state.cdnURL + 'games/icons/' + game.icon"
                            :alt="game.title"
                            class="imageFade"
                          >
                    ...
                    >
                      <div class="columns is-gapless is-mobile card" style="max-height: 175px;">
                        <div class="column is-narrow">
                          <figure
                            class="card image imageFade item-shadow"
                          ...
                          <div class="content is-size-7">
                            <div class="game-detail-header">
                              <div class="tags">
                                ...
                                >{{ game.score ? (game.score + '%') : 'No Score' }}</span>
                              </div>
                            </div>
                            <div class="game-detail-content">{{ game.synopsis }}</div>
                          </div>
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  created() {
    if (this.$route.query.score >= 0 && this.$route.query.score <= 100) {
    ...
    if (this.$route.query.view == "detail") {
      this.simpleView = false;
      this.detailedView = true;
    }
    if (this.$route.query.view == "simple") {
    ...
    axios
      ...
      .then(response => {
        ...
        if (this.$route.query.developer) {
          var developer = this.developers.filter(
            developer => developer.id == this.$route.query.developer
          )[0];
    ...
    axios
      ...
      .then(response => {
        ...
        if (this.$route.query.publisher) {
          var publisher = this.publishers.filter(
            publisher => publisher.id == this.$route.query.publisher
          )[0];
      ...
      .then(response => {
        ...
        if (this.$route.query.platforms) {
          ...
          platformIDArray.forEach(function(element) {
            var platformObject = response.data.find(
              platform => platform.id == element
            );
            if (platformObject) {
              platformObjectArray.push(platformObject);
            }
          });
      ...
      .then(response => {
        ...
        if (this.$route.query.genres) {
          ...
          genreIDArray.forEach(function(element) {
            ...
            if (genreObject) {
              genreObjectArray.push(genreObject);
            }
          });

    ...
    <div v-if="reviews.length > 0">
        <div class="columns is-mobile" v-for="review in reviews">
            ...
            <div class="column">
                <div class="is-clearfix">
                    <div class="is-pulled-left">
                          <div class="control">
                            <div class="tags has-addons">
                                <router-link class="tag is-dark" :to="{name: 'User', params: { id: review.user.id }}"><b>{{ review.user.username }}</b></router-link>
                    ...
                    <div class="is-pulled-right">
                        <div class="field is-grouped is-grouped-multiline">
                          ...
                          <div class="control">
                            <div class="tags has-addons">
                              <a class="tag" :href="'/games?platforms=[' + review.release.platform.id + ']'" :title="review.release.platform.name">{{ review.release.platform.acronym }}</a>
                            </div>
                          </div>
                          <div class="control">
                            <div class="tags has-addons">
                ...
                <div class="content">
                    <blockquote>
                        {{ review.summary | truncate('200') }} <router-link :to="{ name: 'Review', params: { id: review.id }}">[Read More]</router-link>
                    </blockquote>
                </div>              
            </div>
        </div>

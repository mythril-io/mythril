<template>
  <div>
    <section class="hero is-primary">
      <div class="hero-body">
        <div class="container">
          <h1 class="title has-text-centered-desktop">User Reviews</h1>
          <h2 class="subtitle has-text-centered-desktop">
            <span class="has-text-grey-dark is-size-6">Wondering if a game is worth playing?</span>
          </h2>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div v-else-if="reviews.length > 0">
          <article class="message">
            <div class="message-body">Currently, there are
              <strong>{{ total }}</strong> reviews in the database.
              <strong>
        ...
        <div class="columns is-multiline is-centered" v-else>
          <div class="column is-12">
            ...
            >Currently, there are no reviews in the database. Be the first to write one!
              <router-link :to="{name: 'CreateReview'}">Write a Review</router-link>
            </div>
          </div>
        </div>

            ...
            <div class="columns is-mobile is-multiline">
              ...
              <div class="column is-narrow">
                <h1 class="title">
                  ...
                  <!-- <span class="tag is-light">Staff</span> -->
                </h1>
                <h2 class="subtitle">
                  <span
                    class="has-text-light is-size-6"
                  >Joined on {{ this.displayedUser.created_at | dateFormat }}</span>
                </h2>
              </div>
    ...
    userAvatar() {
      if (this.displayedUser.avatar) {
        return (
          ...
          "users/avatars/" +
          this.displayedUser.avatar
        );
      } else {
        return this.$store.state.cdnURL + "users/avatars/default.jpg";
      }
    },
    userBannerURL() {
